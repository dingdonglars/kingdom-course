...
2. **Progress** — one line in `journal/progress.md`: `Module B2.3 — Title — DATE — short build summary. Learnt: one sentence.`
3. **Commit and push** — stage both files, commit message `Module B2.3 done`, Sync.
