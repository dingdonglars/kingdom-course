...
2. **Progress** — one line in `journal/progress.md`: `Module 3.5 — Title — DATE — short build summary. Learnt: one sentence.`
3. **Commit and push** — stage both files, commit message `Module 3.5 done`, Sync.
