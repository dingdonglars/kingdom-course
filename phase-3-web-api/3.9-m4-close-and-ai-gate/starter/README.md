# Module 3.9 starter — M4 close + AI Unlock Gate
...
Change `pre-gate` → `post-gate`. Commit each. Push. **From now on, the AI will help with implementation, with the explanation-as-merge-gate rule.**