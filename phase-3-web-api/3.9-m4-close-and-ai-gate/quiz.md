...
a. Power tools require respect — the discipline you've built (engine vs shell, deterministic tests, explanation as merge gate) is what lets you use AI without losing yourself
